  ...
  return (
    <div className="flex w-full flex-col items-center justify-center gap-3 pt-4 animate-in fade-in duration-300 sm:flex-row">
      <button 
        type="button"
        onClick={onEditClick}
        className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-zinc-900 px-5 py-3 font-medium text-white shadow-lg transition-all hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 sm:w-auto"
      >
      ...
      <button 
        ...
        className="inline-flex w-full items-center justify-center gap-2 rounded-xl border-2 border-zinc-200 bg-white px-5 py-3 font-medium text-zinc-700 shadow-sm transition-all hover:border-zinc-300 hover:text-zinc-900 focus:outline-none focus:ring-2 focus:ring-zinc-500 focus:ring-offset-2 sm:w-auto"
      >
